...
const NearbyCard = ({ PlaceName, setLatitude, setLongitude, onClick }) => {
  ...
  return (
    <section onClick={handleCardClick} className='select-none group active:bg-[#78786a] bg-[#fcf9f1] group-active:border-[#78786a] group-active:border-2  w-full h-auto flex flex-col md:p-2 gap-2 justify-between rounded-md md:rounded-2xl cursor-pointer'>
