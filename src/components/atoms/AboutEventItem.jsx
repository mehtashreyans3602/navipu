...
const AboutEventItem = () => {
    return (
        <section className=' overflow-y-auto bg-[#beecdd] bg-opacity-30 backdrop-blur-sm border-[#002019] border-2 active:border-2 w-60 h-5/6 flex flex-col md:p-4 gap-y-4 justify-between rounded-md md:rounded-2xl cursor-pointer absolute right-5 top-5'>
            ...
            <button className='rounded-full w-full h-auto  text-sm items-center p-3 font-medium flex justify-center gap-x-4 capitalize bg-[#ddeb78] border-2 border-[#1a1e00] text-[#1a1e00]'> <span class="material-symbols-outlined">
                captive_portal
