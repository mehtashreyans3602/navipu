...
const EventsCard = ({ image, eventName, eventDescription }) => {
  return (
    <section className="w-full h-auto bg-[#E4E3D2] rounded-2xl p-2 flex flex-col gap-y-2 items-start cursor-pointer">
      <img
